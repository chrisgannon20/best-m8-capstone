...
export default async function(req, res) {
  ...
  const passcodeExists = await Passcode.exists({ passcode });
  if (passcodeExists) {
    // The passcode exists in the database, login successful
    res.json({ success: true, redirect: '/voting.html' }); // Send redirect URL in JSON response
  } else {
    // The passcode does not exist in the database, login failed
...
// const Passcode = require('src/models/passcode.js');
